    ...
    <div className="mx-auto max-w-[1440px] px-6 pb-28 pt-32 md:px-10 md:pt-40">
      <Reveal>
        <SectionHeading
          ...
          description="Color Furniture manufactures across the categories below. Full product photos and pricing for individual pieces are being added — for now, message us on WhatsApp with the category you're interested in and we'll help right away."
        />
      </Reveal>
